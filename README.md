...
Le tre pagine app condividono **la stessa logica e le stesse correzioni** (fix del log performance-cella, board/lista KPI popolata con le celle monitorate e sparkline, report con criticità, routing automatico "Decidi criticità" → prompt mirato quando la priorità più alta è una performance-cella critica). Cambia solo il layout, adatto al dispositivo:
