...
| `app/pc.html` | **Vista desktop per la postazione in ufficio.** Sidebar fissa, saluto con data, tessere di riepilogo (decisioni aperte, KPI fuori target, agenda di oggi, ultima attività), coda priorità e colori corporate Epoca (blu navy + verde). Stessa logica dati delle altre due viste, ma pensata solo per schermo largo/mouse — non per telefono. Il log delle "Performance cella" alimenta in automatico la tessera KPI (soglia target 85-115%), il Report di oggi e le Decisioni aperte: sotto il 50% si apre da sola una criticità e il pulsante "Decidi criticità" punta dritto al prompt di approfondimento di quella cella. |
